                    ...
                    <div id="sidebar-fusion-wrapper">
                        ...
                        <div id="logoWrapper">
                            ...
                            <select class="selectpicker" data-style="btn-inverse" id="select_project">
                                ...
                                <option value="index.php?page=project_milestones">Project #1</option>
                                <option value="index.php?page=project_milestones">Project #2</option>
                                <option value="index.php?page=project_milestones">Project #3</option>
                            </select>
                        </div>
                            ...
                            <ul class="main pull-right">
                                ...
                                <li class="dropdown username hidden-xs ">
                                    <a href="" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        Adrian D. <span class="caret"></span>
                                    </a>
                                    <ul class="dropdown-menu pull-right">
                                        ...
                                        <li>
                                            <a href="index.php?page=login" class="glyphicons lock no-ajaxify"><i></i>Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
